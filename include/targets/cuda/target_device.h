...
namespace quda
{
  ...
  namespace target
  {
    ...
    template <template <bool, typename...> class f, typename... Args> auto dispatch(Args &&...args)
    {
    ...
    */
    ...
    template <> struct block_dim_impl<true> {
      dim3 operator()() { return dim3(blockDim.x, blockDim.y, blockDim.z); }
    };
#endif
    ...
    */
    ...
    template <> struct grid_dim_impl<true> {
      dim3 operator()() { return dim3(gridDim.x, gridDim.y, gridDim.z); }
    };
#endif
    ...
    */
    ...
    template <> struct block_idx_impl<true> {
      dim3 operator()() { return dim3(blockIdx.x, blockIdx.y, blockIdx.z); }
    };
#endif
    ...
    */
    ...
    template <> struct thread_idx_impl<true> {
      dim3 operator()() { return dim3(threadIdx.x, threadIdx.y, threadIdx.z); }
    };
#endif
