...
#ifdef QUAD_SUM
  template <typename T> inline specialize<T, doubledouble> zero() { return doubledouble(); }
  template <typename T> inline specialize<T, doubledouble2> zero() { return doubledouble2(); }
  template <typename T> inline specialize<T, doubledouble3> zero() { return doubledouble3(); }
#endif

  template <typename T, int n> inline array<T, n> zero()
  {
    array<T, n> v;
#pragma unroll
...
#pragma unroll
  ...
  template <typename T>
  inline std::enable_if_t<std::is_same_v<T, array<complex<typename T::value_type::value_type>, T::N>>, T>
    zero()
  {
    T v;
#pragma unroll
